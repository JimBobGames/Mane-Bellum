...
using System.IO;
using System.Text;
using MBCD = ManeBellum.Core.Data;
using MBCR = ManeBellum.Core.Reference;
...
namespace ManeBellum.Core.Persistence
{
    ...
    {
        public static void LoadReferenceData(MBCD.ManeBellumGame game)
        {
        ...
        public static void LoadGunData(MBCD.ManeBellumGame game)
        {
