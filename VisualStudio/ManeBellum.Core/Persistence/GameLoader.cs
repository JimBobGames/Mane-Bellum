...
namespace ManeBellum.Core.Persistence
{
    public class GameLoader
    {
        public static ManeBellumGame CreateGame()
        {
            ManeBellumGame game = new ManeBellumGame
            {
                TurnNumber = 0
            };
        ...
        private static void CreateFleetsAndTaskForces(ManeBellumGame game)
        {
        ...
        private static void CreatePlayer(ManeBellumGame game)
        {
        ...
        private static void CreateMap(ManeBellumGame game, int size)
        {
        ...
        private static void CreateNations(ManeBellumGame game)
        {
        ...
        private static void CreateDesigns(ManeBellumGame game)
        {
